...
<body>
	<div class="container">
		<h2>Cộng Tiền Người chơi</h2>
		<form method="post" action="../adminapi/money.php">
			<label for="username">Tên người dùng:</label>
			<input type="text" id="username" name="username">

			<label for="vnd">Số tiền muốn cộng:</label>
			<input type="text" id="vnd" name="vnd">

			<input type="submit" value="Cộng tiền">
		</form>
	</div>
	<div class="sidebar">
        <h2>Menu</h2>
