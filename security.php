            ...
            <div class="dashboard-content">
               <div class="security-page dashboard-panel">
                  ...
                  <div class="text-center">
                     <h2 class="heading">Bảo Mật Tài Khoản</h2>
                  </div>
                  <div class="row mt-4 py-4">
                     <div class="col-sm-4 col-6 mb-4">
                        <div class="d-flex flex-column align-items-center">
                           <a href="change-password.php" title="Đổi mật khẩu">
                              <div class="protect-item"> <i class="fas fa-key"></i> </div>
                           </a>
                           <div class="protect-name"> Đổi mật khẩu </div>
                        </div>
                     </div>
                     <div class="col-sm-4 col-6 mb-4">
                        <div class="d-flex flex-column align-items-center">
                           <a href="pass2.php" title="Đổi mật khẩu">
                              <div class="protect-item"> <i class="fas fa-user-lock"></i> </div>
                           </a>
                           <div class="protect-name"> Cập nhật mật khẩu cấp 2 </div>
                        </div>
                     </div>
                  </div>
                  <hr>
